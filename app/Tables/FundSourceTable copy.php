...
class FundSourceTable extends AbstractTable
{
    ...
    public function configure(SpladeTable $table)
    {
        ...
        $table
            ...
            ->column('action')
            ->column('FUNDSOURCE', 'FundSource', sortable: true,hidden:true,searchable:false)
            ...
            ->column('FS_DESCRIPTION', 'Status', sortable: true,hidden:true,searchable:true)
