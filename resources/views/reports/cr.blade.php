...
<head>
    ...
    <title>RSBSA Certificate of Registration</title>
...
body{
    background: url("{{ public_path('storage/images/DA_LETTERHEAD_WRSBSA.png')}}");
...
-->
            ...
            <div style="background-color:transparent; margin:150px 70px 20px 70px;text-align: left">
            ...
            <div style=" background-color:transparent; margin:20px 70px 20px 70px; font-family: Cambria; font-size:17px;">
                    <p style="text-indent:50px; text-align:justify"> This is to certify that <b><u>{{ $rsbsa_cr_no[0]->last_name }}, {{ $rsbsa_cr_no[0]->first_name }} {{ $rsbsa_cr_no[0]->middle_name }}</u></b> a resident of <b><u>{{$rsbsa_cr_no[0]->barangay}}, {{$rsbsa_cr_no[0]->municipality}}, {{$rsbsa_cr_no[0]->province}}</u></b>
                    ...
                    <p style="text-indent:50px;text-align: justify; text-justify: inter-word"> Given this <b><span>{{$receivedate}}</span></b> at the Department of Agriculture Regional Field Office 8, Tacloban City.</p>
            </div>
